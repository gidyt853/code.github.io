let EFV='<div style="position:absolute;z-index:-999;top:-500px;"><a href="https://pr-gidyt.blogspot.com">pr gidyt</a><a href="https://gwareai.in">gwareai</a></div>';document.querySelector("header")?document.querySelector("header").insertAdjacentHTML("beforeend",EFV):document.body.insertAdjacentHTML("beforeend",EFV);
